    ...
    PO.choosePermutation = function(NPCrecordHandle, NPCinfo, permutationsByRaceGender, consistencyRecords, bEnableConsistency, userForcedAssignment, bLinkNPCsWithSameName, LinkedNPCNameExclusions, linkedNPCpermutations, NPClinkGroup, attributeCache, logMessage)
    {
        ...
        if (bSkipSelection === false)
        {
            ...
            if (bSkipRandomSelection === false)
            {
                ...
                permutationToReturn = chooseRandomPermutation(permutations, choiceArray, NPCrecordHandle, userForcedSubgroupsApplied, NPCinfo, failureModes, xelib, logMessage, attributeCache);
            }
        }
...
function chooseRandomPermutation(permutations, choiceArray, NPCrecordHandle, userForcedSubgroupsApplied, NPCinfo, failureModes, xelib, logMessage, attributeCache)
{
