...
module.exports = function(logDir, fh, xelib)
{
    ...
    PO.assignNPCheight = function(NPCrecordHandle, NPCinfo, bEnableConsistency, consistencyRecords, heightSettings, userForcedAssignment, bChangeNonDefaultHeight, bLinkNPCsWithSameName, LinkedNPCNameExclusions, linkedNPCheights, logMessage)
    {
        let lowerBound;
        let upperBound;
        let range;
        ...
        {
            case "male":
                averageHeight = parseFloat(currentHeightSettings.heightMale);
                range = parseFloat(currentHeightSettings.heightMaleRange);
                break;
            case "female":
                averageHeight = parseFloat(currentHeightSettings.heightFemale);
                range = parseFloat(currentHeightSettings.heightFemaleRange);
                break;
        }

        lowerBound = averageHeight - range;
        upperBound = averageHeight + range;
