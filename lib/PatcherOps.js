...
module.exports = function(logDir, fh, xelib)
{
    ...
    PO.assignNPCheight = function(NPCrecordHandle, NPCinfo, bEnableConsistency, consistencyRecords, heightSettings, userForcedAssignment, bChangeNonDefaultHeight, bLinkNPCsWithSameName, LinkedNPCNameExclusions, linkedNPCheights)
    {
        ...
        Aux.updatelinkedNPCdata(bLinkNPCsWithSameName, NPCinfo, heightString, LinkedNPCNameExclusions, linkedNPCheights);
    ...
    PO.choosePermutation = function(NPCrecordHandle, NPCinfo, permutationsByRaceGender, consistencyRecords, bEnableConsistency, userForcedAssignment, bLinkNPCsWithSameName, LinkedNPCNameExclusions, linkedNPCpermutations, attributeCache, logMessage)
    {
        ...
        { 
            addAssignedNPCtoPermutation(originalpermutations, permutationToReturn, NPCinfo);           
            Aux.updatelinkedNPCdata(bLinkNPCsWithSameName, NPCinfo, permutationToReturn, LinkedNPCNameExclusions, linkedNPCpermutations);
            return permutationToReturn; 
        }
        ...
        else 
        {
            ...
            Aux.updatelinkedNPCdata(bLinkNPCsWithSameName, NPCinfo, permutationToReturn, LinkedNPCNameExclusions, linkedNPCpermutations) // store for linking same-named NPCs
...
function drawPermutationFromConsistency(NPCrecordHandle, permutations, consistencyRecords, NPCinfo, bEnableConsistency, bNPCfoundInConsistencyRecords, bUserForcedSubgroupsApplied, bForceIfAttributesApplied, xelib, logMessage, attributeCache)
{
    if (bEnableConsistency === true && bNPCfoundInConsistencyRecords === true)
    {
        ...
        {
            logMessage("Asset Assignment: the permutation specified in the consistency file for " + NPCinfo.name + " (" + NPCinfo.formID + ") could not be assigned consistenly with the subgroups defined in ForceNPCList.json. Assigning a random permutation.");
        }
        else
        {
