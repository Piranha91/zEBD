...
function generatePermutation(assetPackSettings, NPCrecordHandle, userForcedAssignment, NPCinfo, consistencyInfo, bEnableBodyGenIntegration, verboseReport, out_writeVerbose, xelib, logMessage, attributeCache) // assetPackSettings here is a deep copy and can be pruned.
{
    let permutation = {};
    ...
    let bFilteredByUserForceList = filterSubgroupsByForceList(assetPackSettings, userForcedAssignment, verboseLog_UserForceList, out_writeVerbose, logMessage);
    let verboseLog_ForceIfList = [];
    let bFilteredByForceIf = filterSubgroupsByForceIf(assetPackSettings, NPCrecordHandle, verboseLog_ForceIfList, out_writeVerbose, logMessage, xelib, attributeCache);
    let verboseLog_Consistency = [];
    let pre_consistency = angular.copy(assetPackSettings);
    let bFilteredByConsistency = filterSubgroupsByConsistency(assetPackSettings, consistencyInfo, NPCinfo, pre_consistency, verboseLog_Consistency, out_writeVerbose, logMessage);
...
function chooseRandomPermutation(assetPackSettings, assignedBodyGen, bodyGenConfig, BGcategorizedMorphs, bEnableBodyGenIntegration, bEnableConsistency, consistencyRecords, userForcedAssignment, userBlockedAssignment, NPCrecordHandle, bLinkNPCsWithSameName, linkedNPCbodygen, NPClinkGroup, NPCinfo, verboseReport, raceAliases, out_writeVerbose, xelib, logMessage, attributeCache)
{
    ...
    {
       permutationToReturn = generatePermutation(assetPackSettings, NPCrecordHandle, userForcedAssignment, NPCinfo, consistencyRecords[NPCinfo.consistencyIndex], bEnableBodyGenIntegration, currentVerboseReport, out_writeVerbose, xelib, logMessage, attributeCache);
