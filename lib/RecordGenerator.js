...
module.exports = function(logDir, fh)
{
    ...
    RG.generateRecords = function (permutations, settings, helpers)
    {
        ...
        for (let i = 0; i < permutations.length; i++)
        {
            ...
            populatePermutationPaths(permutations[i], settings.recordTemplates, fh, filledTemplateList, excludedExtensions, helpers.logMessage); // replace default template paths with the ones stored in each permutation
