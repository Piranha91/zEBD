...
module.exports = function(logDir, fh, modulePath)
    {
        ...
        IO.saveGeneratedPermutations_Records = function(modulePath, permutations, recordTemplates, maxPriority)
        {
            let path = modulePath + "\\NPC Configuration\\GeneratedPermutations_Records.json";
            let saveObj = {};
        ...
        IO.loadGeneratedPermutations_Records = function(modulePath, locals, RG, logMessage)
        {
            let path = modulePath + "\\NPC Configuration\\GeneratedPermutations_Records.json";
