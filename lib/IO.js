...
module.exports = function(logDir, fh, modulePath)
    {
        ...
        IO.deleteSavedPermutationsRecords = function(pPath)
        {
            let path = pPath + "\\NPC Configuration\\GeneratedPermutations_Records.json";
        ...
        IO.saveGeneratedPermutations_Records = function(savePath, permutations, recordTemplates, maxPriority)
        {
            let path = savePath + "\\NPC Configuration\\GeneratedPermutations_Records.json";
            let saveObj = {};
        ...
        IO.loadGeneratedPermutations_Records = function(loadPath, locals, RG, logMessage)
        {
            let path = loadPath + "\\NPC Configuration\\GeneratedPermutations_Records.json";
            ...
            if (loadObj.recordTemplates === undefined || Object.keys(loadObj.recordTemplates).length === 0)
            {
            ...
            locals.permutations = loadObj.permutations;
            RG.recordTemplates = loadObj.recordTemplates;
            RG.maxPriority = loadObj.maxPriority;
            return true;
        }
