...
module.exports = function()
{
    ...
    BGI.assignMorphs = function(NPCrecordHandle, BGconfig, categorizedMorphs, NPCinfo, bEnableConsistency, consistencyRecords, assignedAssetPermutation, userForcedAssignment, bLinkNPCsWithSameName, linkedNPCBodyGen, NPClinkGroup, bSuppressErrorMessage, aliasList, attributeCache, logMessage, passConsistencyMessage)
    {
        let returnObj = {};
        let assignedMorphs = [];
        let assignedGroups = [];
