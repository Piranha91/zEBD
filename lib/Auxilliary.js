...
module.exports =
    {
        ...
        {
            this.copyArrayInto(copyFrom.allowedRaces, copyTo.allowedRaces);        
            this.copyArrayInto(copyFrom.disallowedRaces, copyTo.disallowedRaces);        
            this.copyArrayInto(copyFrom.allowedAttributes, copyTo.allowedAttributes);       
            this.copyArrayInto(copyFrom.disallowedAttributes, copyTo.disallowedAttributes);       
            this.copyArrayInto(copyFrom.forceIfAttributes, copyTo.forceIfAttributes);
            this.copyArrayInto(copyFrom.weightRange, copyTo.weightRange);        
            this.copyObjectArrayInto(copyFrom.requiredSubgroups, copyTo.requiredSubgroups);       
            this.copyArrayInto(copyFrom.excludedSubgroups, copyTo.excludedSubgroups);       
            this.copyArrayInto(copyFrom.containedSubgroupIDs, copyTo.containedSubgroupIDs);       
            this.copyArrayInto(copyFrom.containedSubgroupNames, copyTo.containedSubgroupNames);       
            this.copyArrayInto(copyFrom.addKeywords, copyTo.addKeywords);
            this.copyArrayInto(copyFrom.paths, copyTo.paths);
            this.copyObjectArrayInto(copyFrom.allowedBodyGenDescriptors, copyTo.allowedBodyGenDescriptors);
            this.copyArrayInto(copyFrom.disallowedBodyGenDescriptors, copyTo.disallowedBodyGenDescriptors);

            this.getArrayUniques(copyTo.allowedRaces);
            this.getArrayUniques(copyTo.disallowedRaces);
            this.getArrayUniques(copyTo.disallowedBodyGenDescriptors);
        },

        /*
        appendSubgroupToPH(subgroup, permutation)
        {
            ...
            this.copyObjectArrayInto(subgroup.allowedBodyGenDescriptors, permutation.allowedBodyGenDescriptors);
        ...
        generateSubgroupArrayByMultiplicity(subgroupList)
        {
