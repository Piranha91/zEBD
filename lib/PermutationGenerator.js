...
module.exports = function()
    {
        ...
        PG.bResolveSubgroupPermutationConflicts = function(subgroup, permutation, subgroupHierarchy, bEnableBodyGenIntegration, verboseError)
        {
            ...
            if (bCompatibilizeDisallowedRaces(subgroup, permutation, false) === false) { verboseError[0] = "The subgroup's disallowedRaces are incompatible with the permutation's disallowedRaces."; return false; } // checks only subgroup
            if (bCompatibilizeDisallowedRaces(permutation, subgroup, false) === false) { verboseError[0] = "The permutation's disallowedRaces are incompatible with the subgroup's disallowedRaces."; return false; } // checks only permutation
        ...
        PG.appendSubgroupToPH = function(subgroup, permutation)
        {
            ...
            permutation.allowedAttributes.push(...convertAttributePairsToObjects(subgroup.allowedAttributes, subgroup));
            permutation.disallowedAttributes.push(...convertAttributePairsToObjects(subgroup.disallowedAttributes, subgroup));
            permutation.forceIfAttributes.push(...convertAttributePairsToObjects(subgroup.forceIfAttributes, subgroup));
